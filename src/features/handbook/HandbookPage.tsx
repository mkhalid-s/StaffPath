...
export function HandbookPage() {
  ...
  return <div className="page handbook-page">
    <div className="page-heading"><div><p className="eyebrow">YOUR PORTABLE SOURCE OF TRUTH</p><h1>Living Staff handbook</h1><p>Evidence, designs, reflections, decisions, and stories collect here as you work.</p></div><button className="button primary" onClick={() => download(`staffpath-handbook-${localDayKey()}.md`, buildHandbookMarkdown(state))}>Export Markdown</button></div>
